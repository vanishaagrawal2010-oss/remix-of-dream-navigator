...
import { GraduationCap, MessageSquare, LayoutDashboard, User, LogOut, Loader2 } from "lucide-react";
  ...
  return (
    <div className="flex min-h-screen bg-background">
      ...
      <main className="flex-1 flex flex-col min-h-screen">
        {/* Mobile nav */}
        <nav className="md:hidden flex items-center justify-between border-b border-border/50 bg-sidebar p-3">
