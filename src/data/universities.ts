...
export const STUDY_PREFERENCES: StudyPreference[] = [
  // ===== Engineering & Technology (BTech / BE / BS) =====
  buildPref("BTech", "Computer Science"),
  buildPref("BTech", "Information Technology"),
  buildPref("BTech", "Data Science"),
  buildPref("BTech", "AI/ML"),
  buildPref("BTech", "Cyber Security"),
  buildPref("BTech", "Software Engineering"),
  buildPref("BTech", "Electronics"),
  buildPref("BTech", "Electrical"),
  buildPref("BTech", "Electronics & Communication"),
  buildPref("BTech", "Mechanical"),
  buildPref("BTech", "Mechatronics"),
  buildPref("BTech", "Civil"),
  buildPref("BTech", "Chemical"),
  buildPref("BTech", "Aerospace"),
  buildPref("BTech", "Aeronautical"),
  buildPref("BTech", "Automobile"),
  buildPref("BTech", "Biotechnology"),
  buildPref("BTech", "Bioinformatics"),
  buildPref("BTech", "Industrial Engineering"),
  buildPref("BTech", "Marine Engineering"),
  buildPref("BTech", "Mining Engineering"),
  buildPref("BTech", "Petroleum Engineering"),
  buildPref("BTech", "Metallurgical Engineering"),
  buildPref("BTech", "Robotics"),
  buildPref("BTech", "Environmental Engineering"),
  buildPref("BTech", "Agricultural Engineering"),
  buildPref("BTech", "Food Technology"),
  buildPref("BTech", "Textile Engineering"),
  buildPref("BS", "Computer Science"),
  buildPref("BS", "Data Science"),
  buildPref("BS", "Mathematics"),
  buildPref("BS", "Physics"),
  buildPref("BS", "Engineering"),
  buildPref("BE", "Computer Science"),
  buildPref("BE", "Mechanical"),
  buildPref("BE", "Electrical"),
  // ===== Medicine, Pharmacy & Allied Health =====
  buildPref("MBBS", "General"),
  buildPref("BDS", "Dentistry"),
  buildPref("BAMS", "Ayurveda"),
  buildPref("BHMS", "Homeopathy"),
  buildPref("BUMS", "Unani"),
  buildPref("BPT", "Physiotherapy"),
  buildPref("BPharma", "Pharmacy"),
  buildPref("DPharma", "Pharmacy"),
  buildPref("BSc", "Nursing"),
  buildPref("BSc", "Radiology"),
  buildPref("BSc", "Medical Lab Technology"),
  buildPref("BSc", "Optometry"),
  buildPref("BVSc", "Veterinary Science"),
  buildPref("BNYS", "Naturopathy & Yoga"),
  buildPref("BOT", "Occupational Therapy"),
  buildPref("BMLT", "Medical Lab Technology"),
  // ===== Business, Commerce & Management =====
  buildPref("BBA", "General"),
  buildPref("BBA", "Finance"),
  buildPref("BBA", "Marketing"),
  buildPref("BBA", "Human Resources"),
  buildPref("BBA", "International Business"),
  buildPref("BBA", "Entrepreneurship"),
  buildPref("BBA", "Business Analytics"),
  buildPref("BCom", "General"),
  buildPref("BCom", "Honours"),
  buildPref("BCom", "Accounting & Finance"),
  buildPref("BCom", "Banking & Insurance"),
  buildPref("BMS", "Management Studies"),
  buildPref("BHM", "Hospitality Management"),
  buildPref("CA", "Chartered Accountancy"),
  buildPref("CS", "Company Secretary"),
  buildPref("CMA", "Cost & Management Accounting"),
  buildPref("MBA", "General"),
  buildPref("MBA", "Finance"),
  buildPref("MBA", "Marketing"),
  buildPref("MBA", "Operations"),
  buildPref("MBA", "Analytics"),
  // ===== Pure Sciences =====
  buildPref("BSc", "Physics"),
  buildPref("BSc", "Chemistry"),
  buildPref("BSc", "Mathematics"),
  buildPref("BSc", "Biology"),
  buildPref("BSc", "Biotechnology"),
  buildPref("BSc", "Microbiology"),
  buildPref("BSc", "Zoology"),
  buildPref("BSc", "Botany"),
  buildPref("BSc", "Statistics"),
  buildPref("BSc", "Computer Science"),
  buildPref("BSc", "Data Science"),
  buildPref("BSc", "Forensic Science"),
  buildPref("BSc", "Environmental Science"),
  buildPref("BSc", "Agriculture"),
  buildPref("BSc", "Geology"),
  // ===== Arts, Humanities & Social Sciences =====
  buildPref("BA", "English Literature"),
  buildPref("BA", "History"),
  buildPref("BA", "Political Science"),
  buildPref("BA", "Economics"),
  buildPref("BA", "Psychology"),
  buildPref("BA", "Sociology"),
  buildPref("BA", "Philosophy"),
  buildPref("BA", "Geography"),
  buildPref("BA", "Journalism & Mass Comm"),
  buildPref("BA", "Public Policy"),
  buildPref("BA", "International Relations"),
  buildPref("BA", "Liberal Arts"),
  buildPref("BA", "Hindi"),
  buildPref("BA", "Sanskrit"),
  buildPref("BA", "Foreign Languages"),
  buildPref("BA", "Anthropology"),
  buildPref("BA", "General"),
  // ===== Law =====
  buildPref("BA LLB", "Law"),
  buildPref("BBA LLB", "Law"),
  buildPref("BCom LLB", "Law"),
  buildPref("LLB", "Law"),
  buildPref("LLM", "Law"),
  // ===== Design, Architecture & Fine Arts =====
  buildPref("BDes", "Design"),
  buildPref("BDes", "Fashion Design"),
  buildPref("BDes", "Industrial Design"),
  buildPref("BDes", "Graphic Design"),
  buildPref("BDes", "UX/UI Design"),
  buildPref("BFA", "Fine Arts"),
  buildPref("BFA", "Painting"),
  buildPref("BFA", "Sculpture"),
  buildPref("BArch", "Architecture"),
  buildPref("BPlan", "Urban Planning"),
  buildPref("BInteriorDesign", "Interior Design"),
  // ===== Computer Applications & IT =====
  buildPref("BCA", "Computer Applications"),
  buildPref("BCA", "Cloud & Cyber Security"),
  buildPref("BCA", "Data Science"),
  buildPref("MCA", "Computer Applications"),
  // ===== Education =====
  buildPref("BEd", "Education"),
  buildPref("BElEd", "Elementary Education"),
  buildPref("BPEd", "Physical Education"),
  // ===== Media, Film & Performing Arts =====
  buildPref("BA", "Film Studies"),
  buildPref("BA", "Performing Arts"),
  buildPref("BSc", "Animation & VFX"),
  buildPref("BSc", "Game Design"),
  // ===== Social Work / Aviation / Other =====
  buildPref("BSW", "Social Work"),
  buildPref("BBA", "Aviation Management"),
  buildPref("BSc", "Aviation"),
  buildPref("BSc", "Hotel Management"),
  // ===== Postgraduate =====
  buildPref("MS", "Computer Science"),
  buildPref("MS", "Data Science"),
  buildPref("MS", "Engineering"),
  buildPref("MTech", "Computer Science"),
  buildPref("MTech", "Mechanical"),
  buildPref("MTech", "Electrical"),
  buildPref("MSc", "Physics"),
  buildPref("MSc", "Chemistry"),
  buildPref("MSc", "Mathematics"),
  buildPref("MSc", "Biotechnology"),
  buildPref("MA", "Economics"),
  buildPref("MA", "Psychology"),
  buildPref("MA", "English"),
  buildPref("MCom", "Commerce"),
  buildPref("MD", "Medicine"),
  buildPref("MS (Med)", "Surgery"),
  buildPref("MPharma", "Pharmacy"),
  buildPref("MArch", "Architecture"),
  buildPref("MDes", "Design"),
